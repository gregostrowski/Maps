...
Map.Map = (function () {
    ...
    pub.initMap = function(canvas, fitButton) {
        ...
        _points = [];
       //_points = new koLocations();

        //ko.ko.applyBindings(_points, document.getElementById("body"));
    ...
    pub.setMapLocation = function(lat, lng, address) {
        _map.setCenter(new google.maps.LatLng(lat, lng));
        pub.addMarker(lat, lng, address);
    };
...
var koLocations = function() {
    var self = this;
    self.points = ko.observableArray([]);
};

var koGeoLocation = function() {
    var self = this;
